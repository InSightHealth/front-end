// E:/fuchuang/learn/demo1/node_modules/recorder-core/src/extensions/wavesurfer.view.js
(function(factory) {
  ...
  fn.prototype = WaveSurferView.prototype = {
    ...
    draw: function(pcmData, sampleRate) {
      ...
      ;
      var pcmDuration = pcmData.length * 1e3 / sampleRate;
      ...
      for (var i = 0, idx = 0; i < pointCount; i++) {
        ...
        ;
        var h = heightY * Math.min(1, max / 32767);
        if (originY != 0) {
...
//# sourceMappingURL=recorder-core_src_extensions_wavesurfer__view__js.js.map
