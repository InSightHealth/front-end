<template>
	<view>
 		<button @click="recReq">请求录音</button>
		<!-- <button @click="recStart">开始录音</button> -->
		<!-- <button @click="recStop">停止录音</button> -->
		<button @mousedown="recStart" @mouseup="recStop">按住录音</button>
		<button @click="recognize">语音识别</button>
	</view>
</template>
