<template>
	<view>
		<!-- #ifdef H5 -->
		<img src="/static/travel/mic1.png" @mousedown="recStart" @mouseup="recStop">按住录音</button>
		<!-- #endif -->
		
		<!-- #ifdef APP -->
		<img src="/static/travel/mic1.png" @touchstart="recStart" @touchend="recStop">按住录音</button>
		<!-- #endif -->
	</view>
</template>
