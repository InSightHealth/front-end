...
(function(vue, shared) {
  ...
  const __easycom_0$7 = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$q], ["__scopeId", "data-v-fe552612"], ["__file", "E:/fuchuang/learn/demo1/components/home-head/home-head.vue"]]);
  ...
  const __easycom_0$6 = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$p], ["__file", "E:/fuchuang/learn/demo1/uni_modules/uni-transition/components/uni-transition/uni-transition.vue"]]);
  const _sfc_main$p = {
    name: "uniPopup",
    components: {},
  ...
  const __easycom_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$o], ["__scopeId", "data-v-4dd3c44b"], ["__file", "E:/fuchuang/learn/demo1/uni_modules/uni-popup/components/uni-popup/uni-popup.vue"]]);
  const innerAudioContext$8 = uni.createInnerAudioContext();
  innerAudioContext$8.autoplay = false;
  innerAudioContext$8.src = "";
  const _sfc_main$o = {
    name: "homeFoot",
    data() {
      return {
    ...
    methods: {
      ...
      navigateHome() {
        ...
        formatAppLog("log", "at components/home-foot/home-foot.vue:58", curRoute, url);
        if (url != curRoute) {
          uni.navigateTo({ url });
        }
      },
      navigatePerson() {
        ...
        formatAppLog("log", "at components/home-foot/home-foot.vue:68", curRoute, url);
        if (url != curRoute) {
          uni.navigateTo({ url });
        }
      },
      assist() {
        ...
        formatAppLog("log", "at components/home-foot/home-foot.vue:79", page);
        this.recoging = false;
        this.holding = true;
        this.holderText = "正在听，请说出你的问题...";
        this.$refs["popup"].open();
        formatAppLog("log", "at components/home-foot/home-foot.vue:86", "开始录音");
        recorderManager.start();
      },
      stopMic() {
        var _this2 = this;
        formatAppLog("log", "at components/home-foot/home-foot.vue:91", "录音结束");
        this.holderText = "正在识别...";
        recorderManager.stop();
        recorderManager.onStop(function(res) {
          formatAppLog("log", "at components/home-foot/home-foot.vue:95", JSON.stringify(res));
          uni.uploadFile({
            ...
            formData: {},
            success: (res2) => {
              formatAppLog("log", "at components/home-foot/home-foot.vue:102", "上传成功：" + JSON.stringify(res2));
              const response = JSON.parse(res2.data);
              _this2.chatMsg = response.text;
              _this2.close();
            },
            fail: (err) => {
              formatAppLog("error", "at components/home-foot/home-foot.vue:107", "上传录音失败：" + err);
              _this2.close();
            }
          });
        });
      ...
      close() {
        const pages = getCurrentPages();
        const page = pages[pages.length - 1];
        formatAppLog("log", "at components/home-foot/home-foot.vue:116", page);
        var index = -1;
        const links = [
        ...
        if (this.chatMsg.includes("出行")) {
          ...
          setTimeout(() => {
            formatAppLog("log", "at components/home-foot/home-foot.vue:142", "Timeout Here!");
            this.$refs["popup"].close();
          }, 5e3);
          const text2 = this.recogText;
          const encoded2 = encodeURI(text2);
          formatAppLog("log", "at components/home-foot/home-foot.vue:148", encoded2);
          innerAudioContext$8.src = `https://tts.baidu.com/text2audio.mp3?lan=ZH&cuid=baike
						&spd=6&ctp=1&amp&pdt=301&tex=` + encoded2;
          formatAppLog("log", "at components/home-foot/home-foot.vue:151", innerAudioContext$8.src);
          innerAudioContext$8.play();
          formatAppLog("log", "at components/home-foot/home-foot.vue:153", "play over!!!");
        }
        setTimeout(() => {
          this.$refs["popup"].close();
          uni.navigateTo({
        ...
        formatAppLog("log", "at components/home-foot/home-foot.vue:166", encoded);
        innerAudioContext$8.src = `https://tts.baidu.com/text2audio.mp3?lan=ZH&cuid=baike
					&spd=6&ctp=1&amp&pdt=301&tex=` + encoded;
        formatAppLog("log", "at components/home-foot/home-foot.vue:169", innerAudioContext$8.src);
        innerAudioContext$8.play();
        formatAppLog("log", "at components/home-foot/home-foot.vue:171", "play over!!!");
      }
    }
  };
      ...
      vue.createElementVNode("footer", { class: "footer-container" }, [
        ...
        vue.createElementVNode("div", { class: "footer-parter-center" }, [
          vue.createElementVNode(
            "img",
            {
              ...
              onTouchstart: _cache[1] || (_cache[1] = (...args) => $options.assist && $options.assist(...args)),
              onTouchend: _cache[2] || (_cache[2] = (...args) => $options.close && $options.close(...args))
            },
            null,
            32
            /* HYDRATE_EVENTS */
        ...
        vue.createElementVNode("div", { class: "footer-parter-right" }, [
          ...
          vue.createElementVNode("img", {
            ...
            class: "icon-footer",
            id: "user-icon",
            onClick: _cache[3] || (_cache[3] = (...args) => $options.navigatePerson && $options.navigatePerson(...args))
          }),
  ...
  const __easycom_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$n], ["__scopeId", "data-v-5c189880"], ["__file", "E:/fuchuang/learn/demo1/components/home-foot/home-foot.vue"]]);
  const _sfc_main$n = {
    data() {
      return {
        holding: true,
  ...
  function _sfc_render$m(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_home_head = resolveEasycom(vue.resolveDynamicComponent("home-head"), __easycom_0$7);
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["render", _sfc_render$m], ["__file", "E:/fuchuang/learn/demo1/pages/index/index.vue"]]);
  const _sfc_main$m = {
    data() {
      return {
        pathList: [
  ...
  const PagesTestTest = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["render", _sfc_render$l], ["__file", "E:/fuchuang/learn/demo1/pages/test/test.vue"]]);
  ...
  if (typeof block0 === "function")
    block0(_sfc_main$l);
  const PagesTest_apiTest_api = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$k], ["__file", "E:/fuchuang/learn/demo1/pages/test_api/test_api.vue"]]);
  const innerAudioContext$7 = uni.createInnerAudioContext();
  innerAudioContext$7.autoplay = false;
  innerAudioContext$7.src = "";
  const _sfc_main$k = {
    name: "bot-chat",
    props: {
      msgList: {
    ...
    methods: {
      play(index) {
        ...
        innerAudioContext$7.src = `https://tts.baidu.com/text2audio.mp3?lan=ZH&cuid=baike
					&spd=` + this.speed + `&ctp=1&amp&pdt=301&tex=` + encoded;
        formatAppLog("log", "at components/cover-chat/cover-chat.vue:80", innerAudioContext$7.src);
        innerAudioContext$7.play();
  ...
  const __easycom_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$j], ["__scopeId", "data-v-cd945a9e"], ["__file", "E:/fuchuang/learn/demo1/components/cover-chat/cover-chat.vue"]]);
  const recorderManager$5 = uni.getRecorderManager();
  const innerAudioContext$6 = uni.createInnerAudioContext();
  innerAudioContext$6.autoplay = true;
  const _sfc_main$j = {
    data() {
      return {
        text: "uni-app",
    ...
    methods: {
      startRecord() {
        ...
        recorderManager$5.start();
      },
      endRecord() {
        let tmpfPath = "";
        formatAppLog("log", "at components/micphone/micphone.vue:25", "录音结束");
        recorderManager$5.stop();
        recorderManager$5.onStop(function(res) {
  ...
  const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$i], ["__scopeId", "data-v-609587ba"], ["__file", "E:/fuchuang/learn/demo1/components/micphone/micphone.vue"]]);
  let _this = null;
  ...
  function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_micphone = resolveEasycom(vue.resolveDynamicComponent("micphone"), __easycom_1$1);
    return vue.openBlock(), vue.createElementBlock(
      "view",
      {
        class: "pengke-camera",
  ...
  const PagesSmartTravelSmartTravel = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$h], ["__scopeId", "data-v-94ba6231"], ["__file", "E:/fuchuang/learn/demo1/pages/smart-travel/smart-travel.vue"]]);
  const recorderManager$3 = uni.getRecorderManager();
  const innerAudioContext$5 = uni.createInnerAudioContext();
  innerAudioContext$5.autoplay = true;
  const _sfc_main$h = {
    data() {
      return {
        text: "uni-app",
    ...
    methods: {
      ...
      playVoice() {
        ...
        if (this.voicePath) {
          innerAudioContext$5.src = this.voicePath;
  ...
  const PagesRecTestNative_test = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$g], ["__file", "E:/fuchuang/learn/demo1/pages/recTest/native_test.vue"]]);
    ...
    methods: {
      ...
      scrollTotop() {
        uni.createSelectorQuery().select(".scroll-view").boundingClientRect((res) => {
          formatAppLog("log", "at pages/smart-chat/smart-chat.vue:152", res);
          const scrollH = res.top;
          formatAppLog("log", "at pages/smart-chat/smart-chat.vue:154", "scroll view selected!!");
          uni.pageScrollTo({
            duration: 100,
            // 过渡时间
            scrollTop: scrollH
      ...
      scrollTobottom() {
        uni.createSelectorQuery().select(`.scroll-view`).boundingClientRect((res) => {
          formatAppLog("log", "at pages/smart-chat/smart-chat.vue:163", res);
          const scrollH = res.bottom;
          formatAppLog("log", "at pages/smart-chat/smart-chat.vue:165", "scroll view selected!!");
          uni.pageScrollTo({
            duration: 100,
            // 过渡时间
            scrollTop: scrollH
      ...
      startRecord() {
        formatAppLog("log", "at pages/smart-chat/smart-chat.vue:188", "开始录音");
        recorderManager$2.start();
      },
      endRecord() {
        var _this2 = this;
        formatAppLog("log", "at pages/smart-chat/smart-chat.vue:193", "录音结束");
        recorderManager$2.stop();
        recorderManager$2.onStop(function(res) {
          formatAppLog("log", "at pages/smart-chat/smart-chat.vue:196", JSON.stringify(res));
          uni.uploadFile({
            url: "http://127.0.0.1:8000/speechtotext",
            filePath: res.tempFilePath,
            name: "mp3",
            formData: {},
            success: (res2) => {
              formatAppLog("log", "at pages/smart-chat/smart-chat.vue:203", "上传成功：" + JSON.stringify(res2));
              const response = JSON.parse(res2.data);
              _this2.chatMsg = response.text;
              _this2.typeSend();
            },
            fail: (err) => {
              formatAppLog("error", "at pages/smart-chat/smart-chat.vue:208", "上传录音失败：" + err);
            }
          });
        });
      },
      typeSend() {
        ...
        uni.request({
          ...
          success: (res) => {
            formatAppLog("log", "at pages/smart-chat/smart-chat.vue:240", res);
            this.msglist.pop();
            try {
              ...
              formatAppLog("log", "at pages/smart-chat/smart-chat.vue:253", encoded);
              ...
              formatAppLog("log", "at pages/smart-chat/smart-chat.vue:266", encoded);
              innerAudioContext$3.src = `https://tts.baidu.com/text2audio.mp3?lan=ZH&cuid=baike
								&spd=` + this.speed + `&ctp=1&amp&pdt=301&tex=` + encoded;
              innerAudioContext$3.play();
            }
          ...
          fail: (err) => {
            formatAppLog("log", "at pages/smart-chat/smart-chat.vue:273", err);
            this.msglist.pop();
            this.msglist.push({
              botContent: "发送失败",
              recordId: 0,
            ...
            innerAudioContext$3.src = `https://tts.baidu.com/text2audio.mp3?lan=ZH&cuid=baike
							&spd=` + this.speed + `&ctp=1&amp&pdt=301&tex=` + encoded;
            formatAppLog("log", "at pages/smart-chat/smart-chat.vue:285", innerAudioContext$3.src);
            innerAudioContext$3.play();
          }
        });
        this.chatMsg = "";
  ...
  const _sfc_main$d = {
    ...
    methods: {
      ...
      micStart() {
        formatAppLog("log", "at components/tab-chat/tab-chat.vue:51", "开始录音");
        formatAppLog("log", "at components/tab-chat/tab-chat.vue:52", this.inputText);
        this.hasPlay = false;
      ...
      micStop() {
        formatAppLog("log", "at components/tab-chat/tab-chat.vue:60", "录音结束");
        this.placeholder = "识别中...";
        recorderManager$1.stop();
        var _this2 = this;
        recorderManager$1.onStop(function(res) {
          formatAppLog("log", "at components/tab-chat/tab-chat.vue:65", res.tempFilePath);
          uni.uploadFile({
            url: "http://127.0.0.1:8000/speechtotext",
            name: "mp3",
            filePath: res.tempFilePath,
            formData: {},
            success: (res2) => {
              formatAppLog("log", "at components/tab-chat/tab-chat.vue:72", "上传成功：" + JSON.stringify(res2));
              if (res2.statusCode == 200) {
                const response = JSON.parse(res2.data);
                formatAppLog("log", "at components/tab-chat/tab-chat.vue:76", response.text);
                _this2.inputText = response.text;
                _this2.placeholder = "";
                _this2.hasInput = true;
                _this2.sendMsg();
              } else {
                _this2.hasPlay = true;
                _this2.playText = "发送失败";
                _this2.playColor = "red";
              }
            },
            fail: (err) => {
              formatAppLog("error", "at components/tab-chat/tab-chat.vue:87", "上传录音失败：" + JSON.stringify(err));
            }
          });
        });
      },
      ...
      play() {
        formatAppLog("log", "at components/tab-chat/tab-chat.vue:111", "播放");
        const encoded = encodeURI(this.playText);
        formatAppLog("log", "at components/tab-chat/tab-chat.vue:114", encoded);
        innerAudioContext$2.src = "https://tts.baidu.com/text2audio.mp3?lan=ZH&cuid=baike&ctp=1&amp&pdt=301&tex=" + encoded;
        formatAppLog("log", "at components/tab-chat/tab-chat.vue:116", innerAudioContext$2.src);
        innerAudioContext$2.play();
        formatAppLog("log", "at components/tab-chat/tab-chat.vue:118", "play over!!!");
      },
      send() {
        this.sendMsg();
      },
      sendMsg() {
        formatAppLog("log", "at components/tab-chat/tab-chat.vue:124", this.inputText, this.photoUrl);
        this.playText = "发送中...";
        this.playColor = "#888888";
        uni.request({
          ...
          success: (res) => {
            formatAppLog("log", "at components/tab-chat/tab-chat.vue:135", res);
            this.hasPlay = true;
            if (res.statusCode == 200) {
              const response = JSON.parse(res.data);
              formatAppLog("log", "at components/tab-chat/tab-chat.vue:140", response);
          ...
          fail: (err) => {
            formatAppLog("log", "at components/tab-chat/tab-chat.vue:154", err);
            this.playText = "发送失败！！";
            this.playColor = "red";
          }
        });
      ...
      textInput() {
        formatAppLog("log", "at components/tab-chat/tab-chat.vue:161", "input....");
        if (this.inputText == "") {
          this.hasInput = false;
          this.placeholder = "你可以点击这里输入,也可以按住下方语音发送";
        } else {
    ...
    onLoad(option) {
      ...
      eventChannel.on("recieveFile", (data) => {
        uni.compressImage({
          ...
          quality: 80,
          success: (res) => {
            formatAppLog("log", "at pages/photo-recog/photo-recog.vue:63", res.tempFilePath);
    ...
    methods: {
      uploadFile(filepath) {
        ...
        uni.uploadFile({
          ...
          success: (res) => {
            formatAppLog("log", "at pages/photo-recog/photo-recog.vue:81", "上传成功：" + JSON.stringify(res));
            if (res.statusCode == 200) {
              const response = JSON.parse(res.data);
              formatAppLog("log", "at pages/photo-recog/photo-recog.vue:85", response.data.image);
              this.photoUrl = response.data.image;
            }
          },
          fail: (err) => {
            formatAppLog("error", "at pages/photo-recog/photo-recog.vue:91", "上传录音失败：" + err.errMsg);
          }
        });
      },
      back() {
      ...
      start(e) {
        ...
        formatAppLog("log", "at pages/photo-recog/photo-recog.vue:111", "this.moveY = ", this.touch.clientY - this.startData.clientY);
  ...
  const _sfc_main$b = {
    ...
    methods: {
      playMusic() {
        ...
        formatAppLog("log", "at pages/test-page/test-page.vue:21", innerAudioContext$1.src);
  ...
  const PagesTestPageTestPage = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__file", "E:/fuchuang/learn/demo1/pages/test-page/test-page.vue"]]);
  const _sfc_main$a = {
    data() {
      return {};
    },
  ...
  const PagesAssistReadAssistRead = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__scopeId", "data-v-64b52ef9"], ["__file", "E:/fuchuang/learn/demo1/pages/assist-read/assist-read.vue"]]);
  ...
  const _sfc_main$9 = {
    ...
    methods: {
      ...
      play() {
        formatAppLog("log", "at components/tab-recog/tab-recog.vue:42", "播放" + this.recogText);
        const encoded = encodeURI(this.recogText);
        formatAppLog("log", "at components/tab-recog/tab-recog.vue:45", encoded);
        innerAudioContext.src = `https://tts.baidu.com/text2audio.mp3?lan=ZH&cuid=baike
				&spd=` + this.speed + `&ctp=1&amp&pdt=301&tex=` + encoded;
        formatAppLog("log", "at components/tab-recog/tab-recog.vue:48", innerAudioContext.src);
        innerAudioContext.play();
        formatAppLog("log", "at components/tab-recog/tab-recog.vue:50", "play over!!!");
      },
      toggle() {
        switch (this.speed) {
          case 3:
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-ba5ee5c4"], ["__file", "E:/fuchuang/learn/demo1/components/tab-recog/tab-recog.vue"]]);
  const _sfc_main$8 = {
    data() {
      return {
        photoPath: "",
    ...
    onLoad(option) {
      ...
      eventChannel.on("recieveFile", (data) => {
        uni.uploadFile({
          ...
          success: (res) => {
            formatAppLog("log", "at pages/assist-read/photo-recog.vue:72", "上传成功：" + JSON.stringify(res));
            if (res.statusCode == 200) {
              const response = JSON.parse(res.data);
              formatAppLog("log", "at pages/assist-read/photo-recog.vue:76", response.data.image);
              this.photoUrl = response.data.image;
              this.handleImg();
            }
          },
          fail: (err) => {
            formatAppLog("error", "at pages/assist-read/photo-recog.vue:84", "上传图片失败：" + err.errMsg);
          }
        });
      });
    },
    methods: {
      ...
      handleImg() {
        var _this2 = this;
        formatAppLog("log", "at pages/assist-read/photo-recog.vue:98", "photoUrl: " + this.photoUrl);
        uni.request({
          ...
          success: (res) => {
            formatAppLog("log", "at pages/assist-read/photo-recog.vue:106", res);
            try {
              const resText = res.data.join("\n");
              _this2.recogText = resText;
              formatAppLog("log", "at pages/assist-read/photo-recog.vue:110", this.recogText);
            } catch (e) {
              _this2.recogText = "发送失败";
            }
          },
          fail: (err) => {
            _this2.recogText = "发送失败";
      ...
      start(e) {
        ...
        formatAppLog("log", "at pages/assist-read/photo-recog.vue:130", this.recogText);
        formatAppLog("log", "at pages/assist-read/photo-recog.vue:131", "this.moveY = ", this.touch.clientY - this.startData.clientY);
        if (this.touch.clientY - this.startData.clientY > 300) {
          this.state = 1;
          this.moveY = 350;
          this.thumbnail = false;
  ...
  const PagesAssistReadPhotoRecog = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-fb8e82d4"], ["__file", "E:/fuchuang/learn/demo1/pages/assist-read/photo-recog.vue"]]);
  const _sfc_main$7 = {
    methods: {
      clickUpload() {
        uni.chooseImage({
  ...
  const PagesTest_apiTestUpload = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__file", "E:/fuchuang/learn/demo1/pages/test_api/test-upload.vue"]]);
  const _sfc_main$6 = {
    data() {
      return {
        gender: false,
    ...
    onLoad() {
      uni.request({
        ...
        success: (res) => {
          formatAppLog("log", "at pages/personal/personal.vue:68", res.data.data);
  ...
  const PagesPersonalPersonal = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "E:/fuchuang/learn/demo1/pages/personal/personal.vue"]]);
  const popup = {
    data() {
      return {};
    },
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-d78c88b7"], ["__file", "E:/fuchuang/learn/demo1/uni_modules/uni-popup/components/uni-popup-dialog/uni-popup-dialog.vue"]]);
  const _sfc_main$4 = {
    data() {
    ...
    onLoad() {
      uni.request({
        ...
        success: (res) => {
          formatAppLog("log", "at pages/personal/profile/profile.vue:99", res.data.data);
          const response = res.data.data;
          this.date = response.birthday;
    ...
    methods: {
      bindPickerChange: function(e) {
        formatAppLog("log", "at pages/personal/profile/profile.vue:131", "picker发送选择改变，携带值为", e.detail.value);
      ...
      changeAvatar() {
        uni.chooseImage({
          ...
          sourceType: ["album"],
          success: (res) => {
            formatAppLog("log", "at pages/personal/profile/profile.vue:190", "chosed" + res.tempFilePaths);
            ...
            uni.uploadFile({
              ...
              success: (res2) => {
                ...
                formatAppLog("log", "at pages/personal/profile/profile.vue:201", data);
                if (data.code == 200) {
                  formatAppLog("log", "at pages/personal/profile/profile.vue:203", data.data.imageUri);
                  this.avatar = data.data.imageUri;
                }
              },
              fail: (err) => {
                formatAppLog("log", "at pages/personal/profile/profile.vue:208", err);
              }
            });
          }
        });
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "system" }, [
      ...
      vue.createElementVNode("view", { class: "line" }),
      vue.createElementVNode("view", { class: "item" }, [
        vue.createElementVNode("view", { class: "item-left" }, " 账号注销 "),
        vue.createElementVNode("image", {
          class: "icon-right",
          src: "/static/personal/more1.png"
        })
  ...
  const PagesPersonalSystemSystem = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-05016e99"], ["__file", "E:/fuchuang/learn/demo1/pages/personal/system/system.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {};
    },
      ...
      login() {
        ...
        uni.request({
          ...
          success: (res) => {
            ...
            formatAppLog("log", "at pages/test-page/login.vue:89", res.data.data.token);
            uni.navigateTo({
              url: "/pages/index/index",
              success() {
                formatAppLog("log", "at pages/test-page/login.vue:93", getApp().globalData.token);
              }
            });
          },
          fail(e) {
            formatAppLog("log", "at pages/test-page/login.vue:98", e);
          }
        });
      }
    }
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "login" }, [
      vue.createElementVNode("view", { class: "head1" }, [
        ...
        vue.createElementVNode("text", { class: "title" }, "明道")
      ]),
      vue.createElementVNode("view", { class: "head2" }, "掌上之眼助慧行"),
        ...
        vue.createElementVNode(
          ...
          [
            vue.createElementVNode("label", null, [
              ...
              vue.createElementVNode("span", { color: "#08DF86" }, "《用户服务协议》"),
              vue.createTextVNode("和"),
              vue.createElementVNode("span", { color: "#08DF86" }, "《隐私政策》")
            ])
          ],
          32
          /* HYDRATE_EVENTS */
  ...
  const PagesTestPageLogin = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-42b6c22f"], ["__file", "E:/fuchuang/learn/demo1/pages/test-page/login.vue"]]);
  ...
  const _sfc_main = {
    ...
    onShow: function() {
      formatAppLog("log", "at App.vue:38", "App Show");
    },
    onHide: function() {
    ...
    methods: {
      ...
      getToken() {
        ...
        val = JSON.parse(val);
        formatAppLog("log", "at App.vue:59", "pre setCache:", val.data);
        if (val.expire && Date.now() / 1e3 - val.time > val.expire) {
          uni.removeStorageSync("token");
          return null;
        }
        formatAppLog("log", "at App.vue:64", "end setCache:", val.data);
        return val.data;
      }
    }
  };
