...
(() => {
  ...
  // E:/fuchuang/learn/demo1/unpackage/dist/dev/.nvue/pages/assist-read/photo_nvue.js
  ...
  var photo_nvue = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "E:/fuchuang/learn/demo1/pages/assist-read/photo_nvue.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/assist-read/photo_nvue";
    let __pageQuery = {};
    try {
